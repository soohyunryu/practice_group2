var jsPsychVirtualChinrest = (function (jspsych) {
    ...
    const info = {
        ...
        parameters: {
            ...
            <p>If you do not have access to a real card you can use a ruler to measure the image width to 3 3/8 inches or 86 mm.</p>
            </div>`,
            },
            ...
            <div style="text-align: left">
              <ol>
                <li>Put your left hand on the <b>space bar</b> (Please do NOT press it yet!).</li>
        ...
        trial(display_element, trial) {
          ...
          <div id="page-size">
            <div id="item" style="border: none; height: ${start_div_height}px; width: ${start_div_width}px; margin: 5px auto; background-color: #ddd; position: relative; ${trial.item_path === null
              ? ""
              : `background-image: url(${trial.item_path}); background-size: s0% auto; background-repeat: no-repeat;`}">
